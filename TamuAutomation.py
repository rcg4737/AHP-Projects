...
###########     Changes Term date to 8/31/2020     ####################
df.loc[df['Term'] != "8/31/2020", 'Term'] = "8/31/2020"        
...
September = pd.DataFrame(df[df.Eff == '09/01/2019'])
October = pd.DataFrame(df[df.Eff == '10/01/2019'])
November = pd.DataFrame(df[df.Eff == '11/01/2019'])
December = pd.DataFrame(df[df.Eff == '12/01/2019'])
January = pd.DataFrame(df[df.Eff == '01/01/2020'])
Febuary = pd.DataFrame(df[df.Eff == '02/01/2020'])
March = pd.DataFrame(df[df.Eff == '03/01/2020'])
April = pd.DataFrame(df[df.Eff == '04/01/2020'])
May = pd.DataFrame(df[df.Eff == '05/01/2020'])
June = pd.DataFrame(df[df.Eff == '06/01/2020'])
July = pd.DataFrame(df[df.Eff == '07/01/2020'])
August = pd.DataFrame(df[df.Eff == '08/01/2020'])
